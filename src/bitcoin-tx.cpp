...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinbam-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinbam-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinbam transaction") + "\n" +
              "  bitcoinbam-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinbam transaction") + "\n" +
              "\n";
