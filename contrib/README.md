...
Contains files used to package bitcoinbamd/bitcoinbam-qt
for Debian-based Linux systems. If you compile bitcoinbamd/bitcoinbam-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building bbitcoinbam-core on RPM based distributions.
